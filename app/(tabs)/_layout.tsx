...
const TabBarIcon = ({focused, icon, title, isCart = false}: TabBarIconProps) => {
  ...
  return (
    <View className="tab-icon">
      ...
      {isCart && totalItems > 0 && (
        <View className="cart-badge -top-3 right-4">
  ...
  return (
    <Tabs screenOptions={{
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Cart',
          tabBarIcon: ({focused}) => <TabBarIcon title="Cart" icon={images.bag} focused={focused} isCart/>
        }}
      />
      <Tabs.Screen
        name='profile'
